...
export const Contact = () => {
    return (
      <div className="relative overflow-hidden bg-black" id = "contact">
        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
              ...
              कोई प्रश्न हैं<br/>या सुझाव?<br/>
              </p>
              
            </div>
            <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
              <div className="relative">
                <div className="relative bg-white rounded shadow-2xl bg-opacity-10 p-7 sm:p-10">
                  <h3 className="mb-4 text-xl font-semibold text-white sm:text-center sm:mb-6 sm:text-2xl ">
                    Contact Us 
                  </h3>
                  <form action = "https://script.google.com/macros/s/AKfycbzcR_zU8myUAOx6lXWpjrlrdb-Ns-8tMod1SG_z0QR4wlg49Y7J1biR3AttBGPz_MIz/exec" class="gform pure-form pure-form-stacked" method="POST" data-email="crypto@gmail.com">
                    ...
                    <div className="mt-4 mb-2 sm:mb-4">
                      <button
                        type="submit"
                        className="inline-flex items-center justify-center w-full h-12 px-6 font-medium tracking-wide text-black bg-white rounded-lg hover:bg-yellow-300 "
                      >
                        Send
                      </button>
                    </div>
                    <div className="hidden thankyou_message">
